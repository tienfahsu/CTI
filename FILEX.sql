...
SELECT  SUBSTRING([PBUNIT]+SPACE(3),1,3) + 
  ...
  SELECT SUBSTRING([TDUNIT]+SPACE(3),1,3) + 
      ...
      SUBSTRING(CAST([TDAMT] AS VARCHAR)+SPACE(16),1,16) + 
      SUBSTRING(CAST([TDSTOPPAYAMT] AS VARCHAR)+SPACE(16),1,16) + 
      ...
      SUBSTRING(CAST([TDINTPAY] AS VARCHAR)+SPACE(16),1,16) + 
      SUBSTRING(CAST([TDINTPAYABLE] AS VARCHAR)+SPACE(16),1,16) + 
      SUBSTRING(CAST([TDVIOLATEAMT] AS VARCHAR)+SPACE(16),1,16) + 
      SUBSTRING([TDPGKIND]+SPACE(1),1,1) + 
      SUBSTRING(CAST([TDPGAMT] AS VARCHAR)+SPACE(16),1,16) + 
      ...
      SUBSTRING([TDLASTTXDATE]+SPACE(8),1,8)     
